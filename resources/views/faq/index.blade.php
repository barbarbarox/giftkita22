    ...
    <div class="max-w-5xl mx-auto">
        ...
        <form method="GET" action="{{ route('faq.index') }}" class="flex flex-col md:flex-row gap-3 justify-center mb-10">
            ...
            <select
                ...
                class="px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#c771d4] focus:outline-none shadow-sm transition-all duration-300 hover:shadow-md hover:scale-105"
            >
        ...
        <div class="space-y-4">
                ...
                >
                    ...
                    >
                        ...
                        <i 
                            ...
                            class="text-2xl text-[#007daf] transition-all duration-300 group-hover:scale-125"
                        ></i>
                    </button>
                    ...
                    >
                        {{-- Tampilkan HTML penuh dari CKEditor dengan styling proper --}}
            ...
            @empty
                <div class="text-center bg-white/20 backdrop-blur-md rounded-2xl p-8 animate-fade-up hover:bg-white/25 transition-all duration-300">
                    ...
                    <p class="text-white text-lg font-medium">Belum ada FAQ yang tersedia.</p>
...
@keyframes border-pulse {
    0%, 100% {
        border-color: rgba(0, 125, 175, 0.3);
    }
    50% {
        border-color: rgba(0, 125, 175, 0.8);
    }
}
